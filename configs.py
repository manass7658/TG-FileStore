...
class Config(object):
	API_ID = int(os.environ.get("27857521"))
	API_HASH = os.environ.get("627b314d25c83e2c9a1a99db9ae0a3ef")
	BOT_TOKEN = os.environ.get("BOT_TOKEN")
	BOT_USERNAME = os.environ.get("Shadowvjbot")
	DB_CHANNEL = int(os.environ.get("DB_CHANNEL", "-1002484381556"))
...
╭────[ **🔅FɪʟᴇSᴛᴏʀᴇBᴏᴛ🔅**]────⍟
│
├🔸🤖 **My Name:** [𝐅𝐢𝐥𝐞 𝐒𝐭𝐨𝐫𝐞 𝐁𝐨𝐭](https://t.me/{Shadowvjbot})
│
